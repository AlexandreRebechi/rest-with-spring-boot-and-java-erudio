INSERT INTO `person` (`id`, `address`, `first_name`, `gender`, `last_name`) VALUES
    ...
    (2, 'Anchiano - Italy - 1500', 'Leonardo', 'Male', 'da Vinci'),
    (4, 'Anchiano - Italy', 'Leonardo', 'Male', 'da Vinci'),
    ...
    (11, 'Smiljan - Croatia', 'Nikolas', 'Male', 'Tesla'),
    (12, 'Smiljan - Croatia', 'Nikolas', 'Male', 'Tesla');
