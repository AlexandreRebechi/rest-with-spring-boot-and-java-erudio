...
class EmailControllerYamlCorsOriginTest extends AbstractIntegrationTest {
    ...
    void sendEmailYamlOriginErudioTest() {
        ...
        var content = given(specification).config(
                ...
                .body(emailRequestDTO, objectMapper)
                .when()
                .post()
                .then()
                .statusCode(200)
    ...
    @Order(2)
    @Disabled("Desabilitado porque o envio de e-mail real está desativado")
    void sendEmailYamlOriginLocalTest() {
        specification = new RequestSpecBuilder()
    ...
    @Order(3)
    @Disabled("Desabilitado porque o envio de e-mail real está desativado")
    void sendEmailYamlWithWrongOrigin() {
        specification = new RequestSpecBuilder()
