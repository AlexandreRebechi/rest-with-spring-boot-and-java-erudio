...
public class BookService {
    ...
    final Logger logger = LoggerFactory.getLogger(BookService.class.getName());
    ...
    public Resource exportPage(Pageable pageable, String acceptHeader) {
        ...
        try {
            ...
            return exporter.exportBooks(books);
        } catch (Exception e) {
    ...
    private void addHateoasLinks(BookDTO dto) {
        ...
        dto.add(linkTo(methodOn(BookController.class)).slash("massCreation").withRel("massCreation").withType("POST"));
