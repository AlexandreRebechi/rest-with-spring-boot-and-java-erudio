...
import com.example.erudio.data.dto.security.TokenDTO;
import com.example.erudio.exception.RequiredObjectIsNullException;
import com.example.erudio.model.User;
import com.example.erudio.repository.UserRepository;
import com.example.erudio.security.jwt.JwtTokenProvider;
...
public class AuthService {
    ...
    public ResponseEntity<TokenDTO> signIn(AccountCredentialsDTO credentials) {
        ...
        if(user == null) throw new UsernameNotFoundException("Usename "+credentials.getUsername()+" not found!");
