...
export default function NewBook() {
    ...
    async function saveOrUpdate(e) {
        ...
        try {
            ...
            console.error("Erro retornado pela API:", err.response?.data || err.message);
            alert('Error while recordiong Book! Try again!')
        }
    }
        ...
        <div className="new-book-container">
            <div className="content">
                <section className="form">
                    ...
                    <p>Enter the book infomation and click on {bookId === '0' ? "'Add'" : "'Update'"}!</p>
