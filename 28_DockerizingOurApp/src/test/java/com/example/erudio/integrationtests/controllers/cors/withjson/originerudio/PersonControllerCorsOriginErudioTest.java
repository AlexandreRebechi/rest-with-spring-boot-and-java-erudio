...
class PersonControllerCorsOriginErudioTest extends AbstractIntegrationTest {
    ...
    void create() throws JsonProcessingException {
        ...
        assertEquals("https://pt.wikipedia.org/wiki/Richard_Stallman", createdPerson.getProfileUrl());
        assertEquals("https://pt.wikipedia.org/wiki/Ficheiro:Richard_Stallman_-_F%C3%AAte_de_l'Humanit%C3%A9_2014_-_010.jpg",createdPerson.getPhotoUrl());
...
// Converte o nó "content" diretamente para a lista de PersonDTO compatível com Spring Boot 4
    ...
    private void mockPerson() {
        ...
        person.setProfileUrl("https://pt.wikipedia.org/wiki/Richard_Stallman");
        person.setPhotoUrl("https://pt.wikipedia.org/wiki/Ficheiro:Richard_Stallman_-_F%C3%AAte_de_l'Humanit%C3%A9_2014_-_010.jpg");
    }
}