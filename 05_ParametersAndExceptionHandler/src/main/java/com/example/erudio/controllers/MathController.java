...
import com.example.erudio.model.math.SimpleMath;
...
public class MathController {
    ...
    public Double division(
        ...
        if(!NumberConverter.isNumeric(numberOne) || !NumberConverter.isNumeric(numberTwo) || NumberConverter.convertToDouble(numberOne) == 0)
            throw new UnsupportedMathOperationException("Please set a numeric value!");
