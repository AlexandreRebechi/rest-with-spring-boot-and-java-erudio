...
import com.example.erudio.controllers.docs.FileControllerDocs;
...
public class FileController implements FileControllerDocs {
    ...
    @Override
    public List<UploadFileResponseDTO> uploadMultipleFile(@RequestParam("file") MultipartFile[] files) {
